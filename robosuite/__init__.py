...
from robosuite.environments.walk import Walk
from robosuite.environments.stand_up import StandUp
from robosuite.environments.climb_stairs import ClimbStairs
